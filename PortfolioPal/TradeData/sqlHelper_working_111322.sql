...
CREATE TABLE `tradedassets`(
	...
	`AmountTraded_Current` FLOAT(10), 
	`AmountTraded_Today` FLOAT(10), 
	`NumberTrades_Current` FLOAT(10), 
	`NumberTrades_Total` FLOAT(10), 
	`NumberBuys_Current` FLOAT(10), 
	`NumberBuys_Total` FLOAT(10), 
	`NumberSells_Current` FLOAT(10), 
	`NumberSells_Total` FLOAT(10), 
	`PLP_Current` FLOAT(10),
	`PLP_Total` FLOAT(10),
	`PLD_Current` FLOAT(10), 
	`PLD_Total` FLOAT(10), 
	`priceBaseline_Current` FLOAT(10), 
	`priceBaseline_Total` FLOAT(10), 
	`assetPLP_Current` FLOAT(10), 
	`assetPLP_Total` FLOAT(10), 
	`performance_Current` FLOAT(10), 
	`performance_Total` FLOAT(10), 
